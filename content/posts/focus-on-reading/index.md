...
- **Previsão (Predicting):** Aqui você `tenta prever o que virá no texto baseado no contexto`, título, imagens ou conhecimento prévio. Isso ajuda a criar uma ideia inicial do conteúdo e preparar o cérebro para o que será lido.
- **Inferência (Inferencing):** Quando você `encontra uma palavra ou frase desconhecida, e usa o contexto ao redor para inferir o significado`. Verificar as palavras próximas e o contexto geral ajuda a deduzir o sentido, mesmo sem entender cada palavra.
- **Ativação do Conhecimento Prévio (Activating Background Knowledge):** `Antes de ler, pense no que você já sabe sobre o assunto`. Essa técnica ajuda a conectar o novo conteúdo ao conhecimento existente, facilitando a compreensão.
...
- **Contextualização Visual:** Use `imagens, gráficos e tabelas para entender o contexto`. Muitos textos apresentam esses recursos como apoio, e eles podem dar pistas valiosas sobre o conteúdo.
